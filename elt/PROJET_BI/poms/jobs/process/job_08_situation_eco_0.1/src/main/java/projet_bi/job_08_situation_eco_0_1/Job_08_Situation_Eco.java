...
package projet_bi.job_08_situation_eco_0_1;
...
/**
 * Job: Job_08_Situation_Eco Purpose: Job_08_Situation_Eco<br>
 * Description: Job_08_Situation_Eco <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Job_08_Situation_Eco implements TalendJob {
	...
	private final String jobName = "Job_08_Situation_Eco";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_08_Situation_Eco.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_08_Situation_Eco.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class situation_eco_OutputStruct
			implements routines.system.IPersistableRow<situation_eco_OutputStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_08_Situation_Eco = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_08_Situation_Eco = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.id_situation_eco;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final situation_eco_OutputStruct other = (situation_eco_OutputStruct) obj;

			if (this.id_situation_eco != other.id_situation_eco)
				return false;

			return true;
		}

		public void copyDataTo(situation_eco_OutputStruct other) {
		...
		public void copyKeysDataTo(situation_eco_OutputStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_Job_08_Situation_Eco.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_Job_08_Situation_Eco.length == 0) {
						commonByteArray_PROJET_BI_Job_08_Situation_Eco = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_Job_08_Situation_Eco = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_Job_08_Situation_Eco, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_08_Situation_Eco, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_Job_08_Situation_Eco, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_08_Situation_Eco, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_08_Situation_Eco) {
		 ...
		 * Compare keys
		 */
		public int compareTo(situation_eco_OutputStruct other) {

			int returnValue = -1;

			returnValue = checkNullsAndCompare(this.id_situation_eco, other.id_situation_eco);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class situation_eco_OutStruct implements routines.system.IPersistableRow<situation_eco_OutStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_08_Situation_Eco = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_08_Situation_Eco = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(situation_eco_OutStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				situation_eco_OutStruct situation_eco_Out = new situation_eco_OutStruct();
				situation_eco_OutputStruct situation_eco_Output = new situation_eco_OutputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "situation_eco_Output");
				}
				...
				String tableName_tDBOutput_1 = "dim_situation_economique";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ognOeVq8TDoOOY3JIevu5ahcXLH0ouDu4W6LhA==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("dim_situation_economique")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_situation_eco` INT(2)   not null ,`id_etudiant` INT(2)  ,`mode_vie` VARCHAR(19)  ,`a_emploi_remunere` INT(1)  ,`heures_emploi_semaine` INT(2)  ,`type_emploi` VARCHAR(17)  ,`beneficie_bourse` INT(1)  ,`montant_bourse_mensuel_fcfa` INT(5)  ,`source_financement_principale` VARCHAR(18)  ,`difficultes_financieres_recurrentes` INT(1)  ,`depenses_mensuelles_fcfa` INT(6)  ,primary key(`id_situation_eco`))");
					}
				}
				String replace_tDBOutput_1 = "REPLACE INTO `" + "dim_situation_economique"
						+ "` (`id_situation_eco`,`id_etudiant`,`mode_vie`,`a_emploi_remunere`,`heures_emploi_semaine`,`type_emploi`,`beneficie_bourse`,`montant_bourse_mensuel_fcfa`,`source_financement_principale`,`difficultes_financieres_recurrentes`,`depenses_mensuelles_fcfa`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "situation_eco_Out");
				}
...
// # Outputs initialization
				situation_eco_OutputStruct situation_eco_Output_tmp = new situation_eco_OutputStruct();
// ###############################
...
// ###############################
// # Outputs initialization
				situation_eco_OutStruct situation_eco_Out_tmp = new situation_eco_OutStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/home/claude/education_bi_v2/dim_situation_economique.csv";
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.id_situation_eco = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"id_situation_eco", "row1", temp, ex_tFileInputDelimited_1),
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'id_situation_eco' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
							...
							row1.mode_vie = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.a_emploi_remunere = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"a_emploi_remunere", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.a_emploi_remunere = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.heures_emploi_semaine = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"heures_emploi_semaine", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.heures_emploi_semaine = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.type_emploi = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.beneficie_bourse = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"beneficie_bourse", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.beneficie_bourse = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.montant_bourse_mensuel_fcfa = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"montant_bourse_mensuel_fcfa", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.montant_bourse_mensuel_fcfa = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row1.source_financement_principale = fid_tFileInputDelimited_1
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.difficultes_financieres_recurrentes = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"difficultes_financieres_recurrentes", "row1", temp,
											ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}

							} else {

								row1.difficultes_financieres_recurrentes = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.depenses_mensuelles_fcfa = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"depenses_mensuelles_fcfa", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.depenses_mensuelles_fcfa = null;
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								situation_eco_Out = null;

// # Output table : 'situation_eco_Out'
								situation_eco_Out_tmp.id_situation_eco = row1.id_situation_eco;
								situation_eco_Out_tmp.id_etudiant = row1.id_etudiant;
								situation_eco_Out_tmp.mode_vie = row1.mode_vie;
								situation_eco_Out_tmp.a_emploi_remunere = row1.a_emploi_remunere;
								situation_eco_Out_tmp.heures_emploi_semaine = row1.heures_emploi_semaine;
								situation_eco_Out_tmp.type_emploi = row1.type_emploi;
								situation_eco_Out_tmp.beneficie_bourse = row1.beneficie_bourse;
								situation_eco_Out_tmp.montant_bourse_mensuel_fcfa = row1.montant_bourse_mensuel_fcfa;
								situation_eco_Out_tmp.source_financement_principale = row1.source_financement_principale;
								situation_eco_Out_tmp.difficultes_financieres_recurrentes = row1.difficultes_financieres_recurrentes;
								situation_eco_Out_tmp.depenses_mensuelles_fcfa = row1.depenses_mensuelles_fcfa;
								situation_eco_Out = situation_eco_Out_tmp;
// ###############################
							 ...
							 */
// Start of branch "situation_eco_Out"
							if (situation_eco_Out != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									Object exprKeyValue_etudiant_Out__id_etudiant = situation_eco_Out.id_etudiant;
								...
								{ // start of Var scope
									...
									situation_eco_Output = null;

									if (!rejectedInnerJoin_tMap_3) {

// # Output table : 'situation_eco_Output'
										situation_eco_Output_tmp.id_situation_eco = situation_eco_Out.id_situation_eco;
										situation_eco_Output_tmp.id_etudiant = situation_eco_Out.id_etudiant;
										situation_eco_Output_tmp.mode_vie = (situation_eco_Out.mode_vie == null)
												? "Chez les parents"
												: situation_eco_Out.mode_vie;
										situation_eco_Output_tmp.a_emploi_remunere = (situation_eco_Out.a_emploi_remunere == null)
												? 0
												: (situation_eco_Out.a_emploi_remunere > 0 ? 1 : 0);
										situation_eco_Output_tmp.heures_emploi_semaine = (situation_eco_Out.a_emploi_remunere == 0)
												? 0
												: (situation_eco_Out.heures_emploi_semaine == null ? 0
														: (situation_eco_Out.heures_emploi_semaine > 80 ? 40
																: situation_eco_Out.heures_emploi_semaine));
										situation_eco_Output_tmp.type_emploi = (situation_eco_Out.a_emploi_remunere == 0)
												? "Aucun"
												: (situation_eco_Out.type_emploi == null ? "Petits boulots"
														: situation_eco_Out.type_emploi);
										situation_eco_Output_tmp.beneficie_bourse = (situation_eco_Out.beneficie_bourse == null)
												? 0
												: (situation_eco_Out.beneficie_bourse > 0 ? 1 : 0);
										situation_eco_Output_tmp.montant_bourse_mensuel_fcfa = (situation_eco_Out.beneficie_bourse == 0)
												? 0
												: (situation_eco_Out.montant_bourse_mensuel_fcfa == null ? 0
														: (situation_eco_Out.montant_bourse_mensuel_fcfa < 0 ? 0
																: situation_eco_Out.montant_bourse_mensuel_fcfa));
										situation_eco_Output_tmp.source_financement_principale = (situation_eco_Out.source_financement_principale == null)
												? "Parents uniquement"
												: situation_eco_Out.source_financement_principale;
										situation_eco_Output_tmp.difficultes_financieres_recurrentes = (situation_eco_Out.difficultes_financieres_recurrentes == null)
												? 0
												: (situation_eco_Out.difficultes_financieres_recurrentes > 0 ? 1 : 0);
										situation_eco_Output_tmp.depenses_mensuelles_fcfa = (situation_eco_Out.depenses_mensuelles_fcfa == null
												|| situation_eco_Out.depenses_mensuelles_fcfa < 0) ? 0
														: situation_eco_Out.depenses_mensuelles_fcfa;
										situation_eco_Output = situation_eco_Output_tmp;
...
// ###############################
								 ...
								 */
// Start of branch "situation_eco_Output"
								if (situation_eco_Output != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1
												...
												, "situation_eco_Output"

										);
									}

									whetherReject_tDBOutput_1 = false;
									pstmt_tDBOutput_1.setInt(1, situation_eco_Output.id_situation_eco);

									if (situation_eco_Output.id_etudiant == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(2, situation_eco_Output.id_etudiant);
									}

									if (situation_eco_Output.mode_vie == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, situation_eco_Output.mode_vie);
									}

									if (situation_eco_Output.a_emploi_remunere == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(4, situation_eco_Output.a_emploi_remunere);
									}

									if (situation_eco_Output.heures_emploi_semaine == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(5, situation_eco_Output.heures_emploi_semaine);
									}

									if (situation_eco_Output.type_emploi == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, situation_eco_Output.type_emploi);
									}

									if (situation_eco_Output.beneficie_bourse == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(7, situation_eco_Output.beneficie_bourse);
									}

									if (situation_eco_Output.montant_bourse_mensuel_fcfa == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(8, situation_eco_Output.montant_bourse_mensuel_fcfa);
									}

									if (situation_eco_Output.source_financement_principale == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9,
												situation_eco_Output.source_financement_principale);
									}

									if (situation_eco_Output.difficultes_financieres_recurrentes == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(10,
												situation_eco_Output.difficultes_financieres_recurrentes);
									}

									if (situation_eco_Output.depenses_mensuelles_fcfa == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(11, situation_eco_Output.depenses_mensuelles_fcfa);
									}
								...
								} // End of branch "situation_eco_Output"
							...
							} // End of branch "situation_eco_Out"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "situation_eco_Out");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "situation_eco_Output");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(situation_eco_Out,etudiant_Out)
				// outputs:(situation_eco_Output)
...
// ###############################      
	...
	public static void main(String[] args) {
		final Job_08_Situation_Eco Job_08_Situation_EcoClass = new Job_08_Situation_Eco();

		int exitCode = Job_08_Situation_EcoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_08_Situation_Eco.class.getClassLoader()
					.getResourceAsStream("projet_bi/job_08_situation_eco_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_08_Situation_Eco.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_08_Situation_Eco");
		}
...
/************************************************************************************************
 * 174768 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2026 à 23:11:42 WAT
 ************************************************************************************************/