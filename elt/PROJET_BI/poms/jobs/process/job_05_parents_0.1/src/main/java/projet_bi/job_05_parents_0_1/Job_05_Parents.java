...
package projet_bi.job_05_parents_0_1;
...
/**
 * Job: Job_05_Parents Purpose: Job_05_Parents<br>
 * Description: Job_05_Parents <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Job_05_Parents implements TalendJob {
	...
	private final String jobName = "Job_05_Parents";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_05_Parents.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_05_Parents.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class parent_OutputStruct implements routines.system.IPersistableRow<parent_OutputStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_05_Parents = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_05_Parents = new byte[0];
		...
		public Integer pere_vivant;

		public Integer getPere_vivant() {
			return this.pere_vivant;
		}
		...
		public String email_pere;

		public String getEmail_pere() {
			return this.email_pere;
		}

		public String niveau_instruction_pere;

		public String getNiveau_instruction_pere() {
			return this.niveau_instruction_pere;
		}

		public String niveau_socioprofessionnel_pere;

		public String getNiveau_socioprofessionnel_pere() {
			return this.niveau_socioprofessionnel_pere;
		}

		public Integer revenu_mensuel_pere_fcfa;

		public Integer getRevenu_mensuel_pere_fcfa() {
			return this.revenu_mensuel_pere_fcfa;
		}

		public Integer mere_vivante;

		public Integer getMere_vivante() {
			return this.mere_vivante;
		}
		...
		public String email_mere;

		public String getEmail_mere() {
			return this.email_mere;
		}

		public String niveau_instruction_mere;

		public String getNiveau_instruction_mere() {
			return this.niveau_instruction_mere;
		}

		public String niveau_socioprofessionnel_mere;

		public String getNiveau_socioprofessionnel_mere() {
			return this.niveau_socioprofessionnel_mere;
		}

		public Integer revenu_mensuel_mere_fcfa;

		public Integer getRevenu_mensuel_mere_fcfa() {
			return this.revenu_mensuel_mere_fcfa;
		}

		public Integer nb_enfants_famille;

		public Integer getNb_enfants_famille() {
			return this.nb_enfants_famille;
		}

		public Integer revenu_total_famille_fcfa;

		public Integer getRevenu_total_famille_fcfa() {
			return this.revenu_total_famille_fcfa;
		}

		public Integer rang_dans_fratrie;

		public Integer getRang_dans_fratrie() {
			return this.rang_dans_fratrie;
		}

		public Integer famille_monoparentale;

		public Integer getFamille_monoparentale() {
			return this.famille_monoparentale;
		}

		public String soutien_financier_famille;

		public String getSoutien_financier_famille() {
			return this.soutien_financier_famille;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.id_parents;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final parent_OutputStruct other = (parent_OutputStruct) obj;

			if (this.id_parents != other.id_parents)
				return false;

			return true;
		}

		public void copyDataTo(parent_OutputStruct other) {

			other.id_parents = this.id_parents;
			other.id_etudiant = this.id_etudiant;
			other.pere_vivant = this.pere_vivant;
			other.nom_pere = this.nom_pere;
			other.prenom_pere = this.prenom_pere;
			other.email_pere = this.email_pere;
			other.niveau_instruction_pere = this.niveau_instruction_pere;
			other.niveau_socioprofessionnel_pere = this.niveau_socioprofessionnel_pere;
			other.revenu_mensuel_pere_fcfa = this.revenu_mensuel_pere_fcfa;
			other.mere_vivante = this.mere_vivante;
			other.nom_mere = this.nom_mere;
			other.prenom_mere = this.prenom_mere;
			other.email_mere = this.email_mere;
			other.niveau_instruction_mere = this.niveau_instruction_mere;
			other.niveau_socioprofessionnel_mere = this.niveau_socioprofessionnel_mere;
			other.revenu_mensuel_mere_fcfa = this.revenu_mensuel_mere_fcfa;
			other.nb_enfants_famille = this.nb_enfants_famille;
			other.revenu_total_famille_fcfa = this.revenu_total_famille_fcfa;
			other.rang_dans_fratrie = this.rang_dans_fratrie;
			other.famille_monoparentale = this.famille_monoparentale;
			other.soutien_financier_famille = this.soutien_financier_famille;

		}

		public void copyKeysDataTo(parent_OutputStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_Job_05_Parents.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_Job_05_Parents.length == 0) {
						commonByteArray_PROJET_BI_Job_05_Parents = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_Job_05_Parents = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_Job_05_Parents, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_05_Parents, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_Job_05_Parents, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_05_Parents, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_05_Parents) {

				try {

					int length = 0;

					this.id_parents = dis.readInt();

					this.id_etudiant = readInteger(dis);

					this.pere_vivant = readInteger(dis);

					this.nom_pere = readString(dis);

					this.prenom_pere = readString(dis);

					this.email_pere = readString(dis);

					this.niveau_instruction_pere = readString(dis);

					this.niveau_socioprofessionnel_pere = readString(dis);

					this.revenu_mensuel_pere_fcfa = readInteger(dis);

					this.mere_vivante = readInteger(dis);

					this.nom_mere = readString(dis);

					this.prenom_mere = readString(dis);

					this.email_mere = readString(dis);

					this.niveau_instruction_mere = readString(dis);

					this.niveau_socioprofessionnel_mere = readString(dis);

					this.revenu_mensuel_mere_fcfa = readInteger(dis);

					this.nb_enfants_famille = readInteger(dis);

					this.revenu_total_famille_fcfa = readInteger(dis);

					this.rang_dans_fratrie = readInteger(dis);

					this.famille_monoparentale = readInteger(dis);

					this.soutien_financier_famille = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.pere_vivant, dos);

				// String

				writeString(this.nom_pere, dos);

				// String

				writeString(this.prenom_pere, dos);

				// String

				writeString(this.email_pere, dos);

				// String

				writeString(this.niveau_instruction_pere, dos);

				// String

				writeString(this.niveau_socioprofessionnel_pere, dos);

				// Integer

				writeInteger(this.revenu_mensuel_pere_fcfa, dos);

				// Integer

				writeInteger(this.mere_vivante, dos);

				// String

				writeString(this.nom_mere, dos);

				// String

				writeString(this.prenom_mere, dos);

				// String

				writeString(this.email_mere, dos);

				// String

				writeString(this.niveau_instruction_mere, dos);

				// String

				writeString(this.niveau_socioprofessionnel_mere, dos);

				// Integer

				writeInteger(this.revenu_mensuel_mere_fcfa, dos);

				// Integer

				writeInteger(this.nb_enfants_famille, dos);

				// Integer

				writeInteger(this.revenu_total_famille_fcfa, dos);

				// Integer

				writeInteger(this.rang_dans_fratrie, dos);

				// Integer

				writeInteger(this.famille_monoparentale, dos);

				// String

				writeString(this.soutien_financier_famille, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("id_parents=" + String.valueOf(id_parents));
			sb.append(",id_etudiant=" + String.valueOf(id_etudiant));
			sb.append(",pere_vivant=" + String.valueOf(pere_vivant));
			sb.append(",nom_pere=" + nom_pere);
			sb.append(",prenom_pere=" + prenom_pere);
			sb.append(",email_pere=" + email_pere);
			sb.append(",niveau_instruction_pere=" + niveau_instruction_pere);
			sb.append(",niveau_socioprofessionnel_pere=" + niveau_socioprofessionnel_pere);
			sb.append(",revenu_mensuel_pere_fcfa=" + String.valueOf(revenu_mensuel_pere_fcfa));
			sb.append(",mere_vivante=" + String.valueOf(mere_vivante));
			sb.append(",nom_mere=" + nom_mere);
			sb.append(",prenom_mere=" + prenom_mere);
			sb.append(",email_mere=" + email_mere);
			sb.append(",niveau_instruction_mere=" + niveau_instruction_mere);
			sb.append(",niveau_socioprofessionnel_mere=" + niveau_socioprofessionnel_mere);
			sb.append(",revenu_mensuel_mere_fcfa=" + String.valueOf(revenu_mensuel_mere_fcfa));
			sb.append(",nb_enfants_famille=" + String.valueOf(nb_enfants_famille));
			sb.append(",revenu_total_famille_fcfa=" + String.valueOf(revenu_total_famille_fcfa));
			sb.append(",rang_dans_fratrie=" + String.valueOf(rang_dans_fratrie));
			sb.append(",famille_monoparentale=" + String.valueOf(famille_monoparentale));
			sb.append(",soutien_financier_famille=" + soutien_financier_famille);
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(parent_OutputStruct other) {

			int returnValue = -1;

			returnValue = checkNullsAndCompare(this.id_parents, other.id_parents);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class parent_OutStruct implements routines.system.IPersistableRow<parent_OutStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_05_Parents = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_05_Parents = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(parent_OutStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parent_OutStruct parent_Out = new parent_OutStruct();
				parent_OutputStruct parent_Output = new parent_OutputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "parent_Output");
				}
				...
				String tableName_tDBOutput_1 = "dim_parents_etudiant";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:unWaYrtYV3LB4zCvHRNJpAZkLrSzzjlDNiAP7Q==");
				...
				String replace_tDBOutput_1 = "REPLACE INTO `" + "dim_parents_etudiant"
						+ "` (`id_parents`,`id_etudiant`,`pere_vivant`,`nom_pere`,`prenom_pere`,`email_pere`,`niveau_instruction_pere`,`niveau_socioprofessionnel_pere`,`revenu_mensuel_pere_fcfa`,`mere_vivante`,`nom_mere`,`prenom_mere`,`email_mere`,`niveau_instruction_mere`,`niveau_socioprofessionnel_mere`,`revenu_mensuel_mere_fcfa`,`nb_enfants_famille`,`revenu_total_famille_fcfa`,`rang_dans_fratrie`,`famille_monoparentale`,`soutien_financier_famille`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "parent_Out");
				}
...
// # Outputs initialization
				parent_OutputStruct parent_Output_tmp = new parent_OutputStruct();
// ###############################
...
// ###############################
// # Outputs initialization
				parent_OutStruct parent_Out_tmp = new parent_OutStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/home/claude/education_bi_v2/dim_parents_etudiant.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/home/claude/education_bi_v2/dim_parents_etudiant.csv", "UTF-8", ",", "\n", true, 1,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.id_parents = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"id_parents", "row1", temp, ex_tFileInputDelimited_1),
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'id_parents' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.pere_vivant = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pere_vivant", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.pere_vivant = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.nom_pere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.prenom_pere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.email_pere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.niveau_instruction_pere = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							row1.niveau_socioprofessionnel_pere = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.revenu_mensuel_pere_fcfa = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"revenu_mensuel_pere_fcfa", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.revenu_mensuel_pere_fcfa = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.mere_vivante = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"mere_vivante", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.mere_vivante = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.nom_mere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							row1.prenom_mere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							row1.email_mere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 13;

							row1.niveau_instruction_mere = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 14;

							row1.niveau_socioprofessionnel_mere = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.revenu_mensuel_mere_fcfa = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"revenu_mensuel_mere_fcfa", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.revenu_mensuel_mere_fcfa = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.nb_enfants_famille = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"nb_enfants_famille", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.nb_enfants_famille = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.revenu_total_famille_fcfa = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"revenu_total_famille_fcfa", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.revenu_total_famille_fcfa = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.rang_dans_fratrie = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"rang_dans_fratrie", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.rang_dans_fratrie = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.famille_monoparentale = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"famille_monoparentale", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.famille_monoparentale = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 20;

							row1.soutien_financier_famille = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'parent_Out'
								parent_Out_tmp.id_parents = row1.id_parents;
								parent_Out_tmp.id_etudiant = row1.id_etudiant;
								parent_Out_tmp.pere_vivant = row1.pere_vivant;
								parent_Out_tmp.nom_pere = row1.nom_pere;
								parent_Out_tmp.prenom_pere = row1.prenom_pere;
								parent_Out_tmp.email_pere = row1.email_pere;
								parent_Out_tmp.niveau_instruction_pere = row1.niveau_instruction_pere;
								parent_Out_tmp.niveau_socioprofessionnel_pere = row1.niveau_socioprofessionnel_pere;
								parent_Out_tmp.revenu_mensuel_pere_fcfa = row1.revenu_mensuel_pere_fcfa;
								parent_Out_tmp.mere_vivante = row1.mere_vivante;
								parent_Out_tmp.nom_mere = row1.nom_mere;
								parent_Out_tmp.prenom_mere = row1.prenom_mere;
								parent_Out_tmp.email_mere = row1.email_mere;
								parent_Out_tmp.niveau_instruction_mere = row1.niveau_instruction_mere;
								parent_Out_tmp.niveau_socioprofessionnel_mere = row1.niveau_socioprofessionnel_mere;
								parent_Out_tmp.revenu_mensuel_mere_fcfa = row1.revenu_mensuel_mere_fcfa;
								parent_Out_tmp.nb_enfants_famille = row1.nb_enfants_famille;
								parent_Out_tmp.revenu_total_famille_fcfa = row1.revenu_total_famille_fcfa;
								parent_Out_tmp.rang_dans_fratrie = row1.rang_dans_fratrie;
								parent_Out_tmp.famille_monoparentale = row1.famille_monoparentale;
								parent_Out_tmp.soutien_financier_famille = row1.soutien_financier_famille;
								parent_Out = parent_Out_tmp;
// ###############################
...
// Start of branch "parent_Out"
							if (parent_Out != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									Object exprKeyValue_etudiant_Out__id_etudiant = parent_Out.id_etudiant;
									...
									if (hasCasePrimitiveKeyWithNull_tMap_3 || !tHash_Lookup_etudiant_Out.hasNext()) { // G_TM_M_090
...
// # Output table : 'parent_Output'
										parent_Output_tmp.id_parents = parent_Out.id_parents;
										parent_Output_tmp.id_etudiant = parent_Out.id_etudiant;
										parent_Output_tmp.pere_vivant = (parent_Out.pere_vivant == null) ? 1
												: (parent_Out.pere_vivant > 0 ? 1 : 0);
										parent_Output_tmp.nom_pere = (parent_Out.pere_vivant == 0) ? null
												: (parent_Out.nom_pere == null ? "Inconnu"
														: parent_Out.nom_pere.trim());
										parent_Output_tmp.prenom_pere = (parent_Out.pere_vivant == 0) ? null
												: (parent_Out.prenom_pere == null ? "Inconnu"
														: parent_Out.prenom_pere.trim());
										parent_Output_tmp.email_pere = (parent_Out.pere_vivant == 0) ? null
												: (parent_Out.email_pere == null ? null
														: parent_Out.email_pere.trim().toLowerCase());
										parent_Output_tmp.niveau_instruction_pere = (parent_Out.niveau_instruction_pere == null)
												? "Primaire"
												: parent_Out.niveau_instruction_pere;
										parent_Output_tmp.niveau_socioprofessionnel_pere = (parent_Out.niveau_socioprofessionnel_pere == null)
												? "Sans emploi"
												: parent_Out.niveau_socioprofessionnel_pere;
										parent_Output_tmp.revenu_mensuel_pere_fcfa = (parent_Out.revenu_mensuel_pere_fcfa == null
												|| parent_Out.revenu_mensuel_pere_fcfa < 0) ? 0
														: parent_Out.revenu_mensuel_pere_fcfa;
										parent_Output_tmp.mere_vivante = (parent_Out.mere_vivante == null) ? 1
												: (parent_Out.mere_vivante > 0 ? 1 : 0);
										parent_Output_tmp.nom_mere = (parent_Out.mere_vivante == 0) ? null
												: (parent_Out.nom_mere == null ? "Inconnue"
														: parent_Out.nom_mere.trim());
										parent_Output_tmp.prenom_mere = (parent_Out.mere_vivante == 0) ? null
												: (parent_Out.prenom_mere == null ? "Inconnue"
														: parent_Out.prenom_mere.trim());
										parent_Output_tmp.email_mere = (parent_Out.mere_vivante == 0) ? null
												: (parent_Out.email_mere == null ? null
														: parent_Out.email_mere.trim().toLowerCase());
										parent_Output_tmp.niveau_instruction_mere = (parent_Out.niveau_instruction_mere == null)
												? "Primaire"
												: parent_Out.niveau_instruction_mere;
										parent_Output_tmp.niveau_socioprofessionnel_mere = (parent_Out.niveau_socioprofessionnel_mere == null)
												? "Sans emploi"
												: parent_Out.niveau_socioprofessionnel_mere;
										parent_Output_tmp.revenu_mensuel_mere_fcfa = (parent_Out.revenu_mensuel_mere_fcfa == null
												|| parent_Out.revenu_mensuel_mere_fcfa < 0) ? 0
														: parent_Out.revenu_mensuel_mere_fcfa;
										parent_Output_tmp.nb_enfants_famille = (parent_Out.nb_enfants_famille == null
												|| parent_Out.nb_enfants_famille < 1) ? 1
														: parent_Out.nb_enfants_famille;
										parent_Output_tmp.revenu_total_famille_fcfa = parent_Out.revenu_mensuel_pere_fcfa
												+ parent_Out.revenu_mensuel_mere_fcfa;
										parent_Output_tmp.rang_dans_fratrie = (parent_Out.rang_dans_fratrie == null
												|| parent_Out.rang_dans_fratrie < 1) ? 1 : parent_Out.rang_dans_fratrie;
										parent_Output_tmp.famille_monoparentale = (parent_Out.famille_monoparentale == null)
												? 0
												: (parent_Out.famille_monoparentale > 0 ? 1 : 0);
										parent_Output_tmp.soutien_financier_famille = java.util.Arrays
												.asList("Aucun", "Partiel", "Total")
												.contains(parent_Out.soutien_financier_famille)
														? parent_Out.soutien_financier_famille
														: "Partiel";
										parent_Output = parent_Output_tmp;
...
// Start of branch "parent_Output"
								if (parent_Output != null) {
									...
									pstmt_tDBOutput_1.setInt(1, parent_Output.id_parents);

									if (parent_Output.id_etudiant == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(2, parent_Output.id_etudiant);
									}

									if (parent_Output.pere_vivant == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(3, parent_Output.pere_vivant);
									}

									if (parent_Output.nom_pere == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, parent_Output.nom_pere);
									}

									if (parent_Output.prenom_pere == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, parent_Output.prenom_pere);
									}

									if (parent_Output.email_pere == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, parent_Output.email_pere);
									}

									if (parent_Output.niveau_instruction_pere == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(7, parent_Output.niveau_instruction_pere);
									}

									if (parent_Output.niveau_socioprofessionnel_pere == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(8, parent_Output.niveau_socioprofessionnel_pere);
									}

									if (parent_Output.revenu_mensuel_pere_fcfa == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(9, parent_Output.revenu_mensuel_pere_fcfa);
									}

									if (parent_Output.mere_vivante == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(10, parent_Output.mere_vivante);
									}

									if (parent_Output.nom_mere == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(11, parent_Output.nom_mere);
									}

									if (parent_Output.prenom_mere == null) {
										pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(12, parent_Output.prenom_mere);
									}

									if (parent_Output.email_mere == null) {
										pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(13, parent_Output.email_mere);
									}

									if (parent_Output.niveau_instruction_mere == null) {
										pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(14, parent_Output.niveau_instruction_mere);
									}

									if (parent_Output.niveau_socioprofessionnel_mere == null) {
										pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(15, parent_Output.niveau_socioprofessionnel_mere);
									}

									if (parent_Output.revenu_mensuel_mere_fcfa == null) {
										pstmt_tDBOutput_1.setNull(16, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(16, parent_Output.revenu_mensuel_mere_fcfa);
									}

									if (parent_Output.nb_enfants_famille == null) {
										pstmt_tDBOutput_1.setNull(17, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(17, parent_Output.nb_enfants_famille);
									}

									if (parent_Output.revenu_total_famille_fcfa == null) {
										pstmt_tDBOutput_1.setNull(18, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(18, parent_Output.revenu_total_famille_fcfa);
									}

									if (parent_Output.rang_dans_fratrie == null) {
										pstmt_tDBOutput_1.setNull(19, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(19, parent_Output.rang_dans_fratrie);
									}

									if (parent_Output.famille_monoparentale == null) {
										pstmt_tDBOutput_1.setNull(20, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(20, parent_Output.famille_monoparentale);
									}

									if (parent_Output.soutien_financier_famille == null) {
										pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(21, parent_Output.soutien_financier_famille);
									}
					...
					if (!((Object) ("C:/home/claude/education_bi_v2/dim_parents_etudiant.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "parent_Out");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "parent_Output");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(parent_Out,etudiant_Out)
...
// ###############################      
	...
	public static void main(String[] args) {
		final Job_05_Parents Job_05_ParentsClass = new Job_05_Parents();

		int exitCode = Job_05_ParentsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_05_Parents.class.getClassLoader()
					.getResourceAsStream("projet_bi/job_05_parents_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_05_Parents.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_05_Parents");
		}
...
/************************************************************************************************
 * 197635 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2026 à 23:14:08 WAT
 ************************************************************************************************/