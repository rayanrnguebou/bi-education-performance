...
package projet_bi.job_04_sante_0_1;
...
/**
 * Job: Job_04_Sante Purpose: Job_04_Sante<br>
 * Description: Job_04_Sante <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Job_04_Sante implements TalendJob {
	...
	private final String jobName = "Job_04_Sante";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_04_Sante.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class sante_OutputStruct implements routines.system.IPersistableRow<sante_OutputStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_04_Sante = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_04_Sante = new byte[0];
		...
		public String frequence_consultation;

		public String getFrequence_consultation() {
		...
		public String probleme_sante_mentale;

		public String getProbleme_sante_mentale() {
			return this.probleme_sante_mentale;
		}

		public int nb_hospitalisations_annuelles;

		public int getNb_hospitalisations_annuelles() {
			return this.nb_hospitalisations_annuelles;
		}

		public int handicap_physique;

		public int getHandicap_physique() {
			return this.handicap_physique;
		}

		public int acces_assurance_maladie;

		public int getAcces_assurance_maladie() {
			return this.acces_assurance_maladie;
		}

		public String impact_sante_sur_etudes;

		public String getImpact_sante_sur_etudes() {
			return this.impact_sante_sur_etudes;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.id_sante;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final sante_OutputStruct other = (sante_OutputStruct) obj;

			if (this.id_sante != other.id_sante)
				return false;

			return true;
		}

		public void copyDataTo(sante_OutputStruct other) {

			other.id_sante = this.id_sante;
			other.id_etudiant = this.id_etudiant;
			other.frequence_consultation = this.frequence_consultation;
			other.maladie_chronique = this.maladie_chronique;
			other.probleme_sante_mentale = this.probleme_sante_mentale;
			other.nb_hospitalisations_annuelles = this.nb_hospitalisations_annuelles;
			other.handicap_physique = this.handicap_physique;
			other.acces_assurance_maladie = this.acces_assurance_maladie;
			other.impact_sante_sur_etudes = this.impact_sante_sur_etudes;

		}

		public void copyKeysDataTo(sante_OutputStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_Job_04_Sante.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_Job_04_Sante.length == 0) {
						commonByteArray_PROJET_BI_Job_04_Sante = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_Job_04_Sante = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_Job_04_Sante, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_04_Sante, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_Job_04_Sante, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_04_Sante, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_04_Sante) {

				try {

					int length = 0;

					this.id_sante = dis.readInt();

					this.id_etudiant = dis.readInt();

					this.frequence_consultation = readString(dis);

					this.maladie_chronique = readString(dis);

					this.probleme_sante_mentale = readString(dis);

					this.nb_hospitalisations_annuelles = dis.readInt();

					this.handicap_physique = dis.readInt();

					this.acces_assurance_maladie = dis.readInt();

					this.impact_sante_sur_etudes = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.frequence_consultation, dos);

				// String

				writeString(this.maladie_chronique, dos);

				// String

				writeString(this.probleme_sante_mentale, dos);

				// int

				dos.writeInt(this.nb_hospitalisations_annuelles);

				// int

				dos.writeInt(this.handicap_physique);

				// int

				dos.writeInt(this.acces_assurance_maladie);

				// String

				writeString(this.impact_sante_sur_etudes, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("id_sante=" + String.valueOf(id_sante));
			sb.append(",id_etudiant=" + String.valueOf(id_etudiant));
			sb.append(",frequence_consultation=" + frequence_consultation);
			sb.append(",maladie_chronique=" + maladie_chronique);
			sb.append(",probleme_sante_mentale=" + probleme_sante_mentale);
			sb.append(",nb_hospitalisations_annuelles=" + String.valueOf(nb_hospitalisations_annuelles));
			sb.append(",handicap_physique=" + String.valueOf(handicap_physique));
			sb.append(",acces_assurance_maladie=" + String.valueOf(acces_assurance_maladie));
			sb.append(",impact_sante_sur_etudes=" + impact_sante_sur_etudes);
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(sante_OutputStruct other) {

			int returnValue = -1;

			returnValue = checkNullsAndCompare(this.id_sante, other.id_sante);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class sante_outStruct implements routines.system.IPersistableRow<sante_outStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_04_Sante = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_04_Sante = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(sante_outStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public Integer nb_hospitalisations_annuelles;

		public Integer getNb_hospitalisations_annuelles() {
			return this.nb_hospitalisations_annuelles;
		}

		public Integer handicap_physique;

		public Integer getHandicap_physique() {
			return this.handicap_physique;
		}

		public Integer acces_assurance_maladie;

		public Integer getAcces_assurance_maladie() {
			return this.acces_assurance_maladie;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_04_Sante) {
				...
				try {
					...
					this.nb_hospitalisations_annuelles = readInteger(dis);

					this.handicap_physique = readInteger(dis);

					this.acces_assurance_maladie = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.nb_hospitalisations_annuelles, dos);

				// Integer

				writeInteger(this.handicap_physique, dos);

				// Integer

				writeInteger(this.acces_assurance_maladie, dos);
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				sante_outStruct sante_out = new sante_outStruct();
				sante_OutputStruct sante_Output = new sante_OutputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "sante_Output");
				}
				...
				String tableName_tDBOutput_1 = "dim_sante_etudiant";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:sRDYepezhGZuOHGDK6XMhwYDls1RCG7VXxn68w==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("dim_sante_etudiant")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_sante` INT(10)   not null ,`id_etudiant` INT(10)   not null ,`frequence_consultation` VARCHAR(20)  default 'Jamais'  not null ,`maladie_chronique` VARCHAR(30)  default 'Aucune'  not null ,`probleme_sante_mentale` VARCHAR(30)  default 'Aucun'  not null ,`nb_hospitalisations_annuelles` INT(3)  default '0'  not null ,`handicap_physique` INT(1)  default '0'  not null ,`acces_assurance_maladie` INT(1)  default '0'  not null ,`impact_sante_sur_etudes` VARCHAR(10)  default 'Nul'  not null ,primary key(`id_sante`))");
					}
				}
				String replace_tDBOutput_1 = "REPLACE INTO `" + "dim_sante_etudiant"
						+ "` (`id_sante`,`id_etudiant`,`frequence_consultation`,`maladie_chronique`,`probleme_sante_mentale`,`nb_hospitalisations_annuelles`,`handicap_physique`,`acces_assurance_maladie`,`impact_sante_sur_etudes`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "sante_out");
				}
...
// # Outputs initialization
				sante_OutputStruct sante_Output_tmp = new sante_OutputStruct();
// ###############################
...
// ###############################
// # Outputs initialization
				sante_outStruct sante_out_tmp = new sante_outStruct();
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/home/claude/education_bi_v2/dim_sante_etudiant.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/home/claude/education_bi_v2/dim_sante_etudiant.csv", "UTF-8", ",", "\n", true, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.id_sante = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"id_sante", "row1", temp, ex_tFileInputDelimited_1),
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'id_sante' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
							...
							row1.frequence_consultation = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.maladie_chronique = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.probleme_sante_mentale = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.nb_hospitalisations_annuelles = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"nb_hospitalisations_annuelles", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.nb_hospitalisations_annuelles = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.handicap_physique = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"handicap_physique", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.handicap_physique = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.acces_assurance_maladie = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"acces_assurance_maladie", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.acces_assurance_maladie = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row1.impact_sante_sur_etudes = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'sante_out'
								sante_out_tmp.id_sante = row1.id_sante;
								sante_out_tmp.id_etudiant = row1.id_etudiant;
								sante_out_tmp.frequence_consultation = (row1.frequence_consultation == null) ? "Jamais"
										: row1.frequence_consultation;
								sante_out_tmp.maladie_chronique = (row1.maladie_chronique == null) ? "Aucune"
										: row1.maladie_chronique;
								sante_out_tmp.probleme_sante_mentale = (row1.probleme_sante_mentale == null) ? "Aucun"
										: row1.probleme_sante_mentale;
								sante_out_tmp.nb_hospitalisations_annuelles = row1.nb_hospitalisations_annuelles;
								sante_out_tmp.handicap_physique = row1.handicap_physique;
								sante_out_tmp.acces_assurance_maladie = row1.acces_assurance_maladie;
								sante_out_tmp.impact_sante_sur_etudes = (row1.impact_sante_sur_etudes == null) ? "Nul"
										: row1.impact_sante_sur_etudes;
								sante_out = sante_out_tmp;
// ###############################
...
// Start of branch "sante_out"
							if (sante_out != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									Object exprKeyValue_etudiant_Out__id_etudiant = sante_out.id_etudiant;
...
// # Output table : 'sante_Output'
										sante_Output_tmp.id_sante = sante_out.id_sante;
										sante_Output_tmp.id_etudiant = sante_out.id_etudiant;
										sante_Output_tmp.frequence_consultation = (sante_out.frequence_consultation == null)
												? "Jamais"
												: sante_out.frequence_consultation;
										sante_Output_tmp.maladie_chronique = (sante_out.maladie_chronique == null)
												? "Aucune"
												: sante_out.maladie_chronique;
										sante_Output_tmp.probleme_sante_mentale = (sante_out.probleme_sante_mentale == null)
												? "Aucun"
												: sante_out.probleme_sante_mentale;
										sante_Output_tmp.nb_hospitalisations_annuelles = (sante_out.nb_hospitalisations_annuelles < 0)
												? 0
												: sante_out.nb_hospitalisations_annuelles;
										sante_Output_tmp.handicap_physique = (sante_out.handicap_physique > 0 ? 1 : 0);
										sante_Output_tmp.acces_assurance_maladie = (sante_out.acces_assurance_maladie > 0
												? 1
												: 0);
										sante_Output_tmp.impact_sante_sur_etudes = java.util.Arrays
												.asList("Nul", "Faible", "Modéré", "Élevé")
												.contains(sante_out.impact_sante_sur_etudes)
														? sante_out.impact_sante_sur_etudes
														: "Nul";
										sante_Output = sante_Output_tmp;
...
// ###############################
								 ...
								 */
// Start of branch "sante_Output"
								if (sante_Output != null) {
									...
									pstmt_tDBOutput_1.setInt(1, sante_Output.id_sante);

									pstmt_tDBOutput_1.setInt(2, sante_Output.id_etudiant);

									if (sante_Output.frequence_consultation == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, sante_Output.frequence_consultation);
									}

									if (sante_Output.maladie_chronique == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, sante_Output.maladie_chronique);
									}

									if (sante_Output.probleme_sante_mentale == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, sante_Output.probleme_sante_mentale);
									}

									pstmt_tDBOutput_1.setInt(6, sante_Output.nb_hospitalisations_annuelles);

									pstmt_tDBOutput_1.setInt(7, sante_Output.handicap_physique);

									pstmt_tDBOutput_1.setInt(8, sante_Output.acces_assurance_maladie);

									if (sante_Output.impact_sante_sur_etudes == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9, sante_Output.impact_sante_sur_etudes);
									}
					...
					if (!((Object) ("C:/home/claude/education_bi_v2/dim_sante_etudiant.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "sante_out");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "sante_Output");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(sante_out,etudiant_Out) outputs:(sante_Output)
...
// ###############################      
	...
	public static void main(String[] args) {
		final Job_04_Sante Job_04_SanteClass = new Job_04_Sante();

		int exitCode = Job_04_SanteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_04_Sante.class.getClassLoader()
					.getResourceAsStream("projet_bi/job_04_sante_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_04_Sante.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_04_Sante");
		}
...
/************************************************************************************************
 * 162397 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2026 à 23:14:33 WAT
 ************************************************************************************************/