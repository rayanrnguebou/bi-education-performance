...
package projet_bi.job_09_matiere_0_1;
...
/**
 * Job: Job_09_Matiere Purpose: Job_09_Matiere<br>
 * Description: Job_09_Matiere <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Job_09_Matiere implements TalendJob {
	...
	private final String jobName = "Job_09_Matiere";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_09_Matiere.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_09_Matiere.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class matiere_OutputStruct implements routines.system.IPersistableRow<matiere_OutputStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_09_Matiere = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_09_Matiere = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_Job_09_Matiere.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_Job_09_Matiere.length == 0) {
						commonByteArray_PROJET_BI_Job_09_Matiere = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_Job_09_Matiere = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_Job_09_Matiere, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_09_Matiere, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_Job_09_Matiere, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_09_Matiere, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_09_Matiere) {
				...
				try {
					...
					this.coefficient = dis.readInt();

					this.credits = dis.readInt();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.coefficient);

				// int

				dos.writeInt(this.credits);
		 ...
		 * Compare keys
		 */
		public int compareTo(matiere_OutputStruct other) {
	...
	public static class matiere_OutStruct implements routines.system.IPersistableRow<matiere_OutStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_09_Matiere = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_09_Matiere = new byte[0];
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				matiere_OutputStruct matiere_Output = new matiere_OutputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "matiere_Output");
				}
				...
				String tableName_tDBOutput_1 = "dim_matiere";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:qdpLumEC69vjQ/uNQ9WIU4s7j4ZF7iKuKgiyEw==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("dim_matiere")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_matiere` INT(10)   not null ,`code_matiere` VARCHAR(10)   not null ,`nom_matiere` VARCHAR(100)   not null ,`id_filiere` INT(2)  ,`coefficient` INT(3)  default '1'  not null ,`credits` INT(3)  default '3'  not null ,`type_matiere` VARCHAR(30)   not null ,`semestre` INT(3)   not null )");
					}
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_matiere"
						+ "` (`id_matiere`,`code_matiere`,`nom_matiere`,`id_filiere`,`coefficient`,`credits`,`type_matiere`,`semestre`) VALUES (?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				matiere_OutputStruct matiere_Output_tmp = new matiere_OutputStruct();
// ###############################
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/home/claude/education_bi_v2/dim_matiere.csv";
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.id_matiere = ParserUtils.parseTo_int(temp);
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'id_matiere' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));

							}

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.code_matiere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row1.nom_matiere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.coefficient = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"coefficient", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.coefficient = null;
							...
							row1.type_matiere = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.semestre = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"semestre", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// # Output table : 'matiere_Out'
								matiere_Out_tmp.id_matiere = row1.id_matiere;
								matiere_Out_tmp.code_matiere = row1.code_matiere;
								matiere_Out_tmp.nom_matiere = row1.nom_matiere;
								matiere_Out_tmp.id_filiere = row1.id_filiere;
								matiere_Out_tmp.coefficient = row1.coefficient;
								matiere_Out_tmp.credits = row1.credits;
								matiere_Out_tmp.type_matiere = row1.type_matiere;
								matiere_Out_tmp.semestre = row1.semestre;
...
// Start of branch "matiere_Out"
							if (matiere_Out != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									Object exprKeyValue_filiere_Out__id_filiere = matiere_Out.id_filiere;
...
// # Output table : 'matiere_Output'
										matiere_Output_tmp.id_matiere = matiere_Out.id_matiere;
										matiere_Output_tmp.code_matiere = matiere_Out.code_matiere.trim().toUpperCase();
										matiere_Output_tmp.nom_matiere = matiere_Out.nom_matiere.trim();
										matiere_Output_tmp.id_filiere = matiere_Out.id_filiere;
										matiere_Output_tmp.coefficient = (matiere_Out.coefficient < 1) ? 1
												: matiere_Out.coefficient;
										matiere_Output_tmp.credits = (matiere_Out.credits < 1) ? 3
												: matiere_Out.credits;
										matiere_Output_tmp.type_matiere = (matiere_Out.type_matiere == null)
												? "Fondamentale"
												: matiere_Out.type_matiere;
										matiere_Output_tmp.semestre = (matiere_Out.semestre < 1
												|| matiere_Out.semestre > 2) ? 1 : matiere_Out.semestre;
										matiere_Output = matiere_Output_tmp;
...
// ###############################
								 ...
								 */
// Start of branch "matiere_Output"
								if (matiere_Output != null) {
									...
									pstmt_tDBOutput_1.setInt(1, matiere_Output.id_matiere);

									if (matiere_Output.code_matiere == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, matiere_Output.code_matiere);
									}

									if (matiere_Output.nom_matiere == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, matiere_Output.nom_matiere);
									}

									if (matiere_Output.id_filiere == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(4, matiere_Output.id_filiere);
									}

									pstmt_tDBOutput_1.setInt(5, matiere_Output.coefficient);

									pstmt_tDBOutput_1.setInt(6, matiere_Output.credits);

									if (matiere_Output.type_matiere == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(7, matiere_Output.type_matiere);
									}

									pstmt_tDBOutput_1.setInt(8, matiere_Output.semestre);
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "matiere_Output");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(matiere_Out,filiere_Out)
				// outputs:(matiere_Output)
...
// ###############################      
	...
	public static void main(String[] args) {
		final Job_09_Matiere Job_09_MatiereClass = new Job_09_Matiere();

		int exitCode = Job_09_MatiereClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_09_Matiere.class.getClassLoader()
					.getResourceAsStream("projet_bi/job_09_matiere_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_09_Matiere.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_09_Matiere");
		}
...
/************************************************************************************************
 * 132108 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2026 à 23:10:28 WAT
 ************************************************************************************************/