...
package projet_bi.job_06_integration_0_1;
...
/**
 * Job: Job_06_Integration Purpose: Job_06_Integration<br>
 * Description: Job_06_Integration <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Job_06_Integration implements TalendJob {
	...
	private final String jobName = "Job_06_Integration";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_06_Integration.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_06_Integration.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class integration_OutputStruct implements routines.system.IPersistableRow<integration_OutputStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_06_Integration = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_06_Integration = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.id_integration;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final integration_OutputStruct other = (integration_OutputStruct) obj;

			if (this.id_integration != other.id_integration)
				return false;

			return true;
		}

		public void copyDataTo(integration_OutputStruct other) {
		...
		public void copyKeysDataTo(integration_OutputStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_Job_06_Integration.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_Job_06_Integration.length == 0) {
						commonByteArray_PROJET_BI_Job_06_Integration = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_Job_06_Integration = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_Job_06_Integration, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_06_Integration, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_Job_06_Integration, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_06_Integration, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_06_Integration) {
		 ...
		 * Compare keys
		 */
		public int compareTo(integration_OutputStruct other) {

			int returnValue = -1;

			returnValue = checkNullsAndCompare(this.id_integration, other.id_integration);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class integration_OutStruct implements routines.system.IPersistableRow<integration_OutStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_06_Integration = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_06_Integration = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(integration_OutStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				integration_OutStruct integration_Out = new integration_OutStruct();
				integration_OutputStruct integration_Output = new integration_OutputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "integration_Output");
				}
				...
				String tableName_tDBOutput_1 = "dim_integration_sociale";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:2isLFxbLmgxAZ6SyBBXKOFmFSf0Udg2+FrPVuA==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("dim_integration_sociale")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_integration` INT(2)   not null ,`id_etudiant` INT(2)  ,`qualite_relation_camarades` VARCHAR(14)  ,`niveau_integration_sociale` VARCHAR(13)  ,`isolement_social` INT(1)  ,`victime_harcelement` INT(1)  ,`type_harcelement` VARCHAR(17)  ,`pair_ayant_decroche_avant` INT(1)  ,`qualite_relation_enseignants` VARCHAR(14)  ,`beneficie_soutien_camarades` INT(1)  ,`beneficie_soutien_enseignants` INT(1)  ,`participation_activites_campus` VARCHAR(8)  ,primary key(`id_integration`))");
					}
				}
				String replace_tDBOutput_1 = "REPLACE INTO `" + "dim_integration_sociale"
						+ "` (`id_integration`,`id_etudiant`,`qualite_relation_camarades`,`niveau_integration_sociale`,`isolement_social`,`victime_harcelement`,`type_harcelement`,`pair_ayant_decroche_avant`,`qualite_relation_enseignants`,`beneficie_soutien_camarades`,`beneficie_soutien_enseignants`,`participation_activites_campus`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "integration_Out");
				}
...
// # Outputs initialization
				integration_OutputStruct integration_Output_tmp = new integration_OutputStruct();
// ###############################
...
// ###############################
// # Outputs initialization
				integration_OutStruct integration_Out_tmp = new integration_OutStruct();
// ###############################
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								integration_Out = null;

// # Output table : 'integration_Out'
								integration_Out_tmp.id_integration = row1.id_integration;
								integration_Out_tmp.id_etudiant = row1.id_etudiant;
								integration_Out_tmp.qualite_relation_camarades = row1.qualite_relation_camarades;
								integration_Out_tmp.niveau_integration_sociale = row1.niveau_integration_sociale;
								integration_Out_tmp.isolement_social = row1.isolement_social;
								integration_Out_tmp.victime_harcelement = row1.victime_harcelement;
								integration_Out_tmp.type_harcelement = row1.type_harcelement;
								integration_Out_tmp.pair_ayant_decroche_avant = row1.pair_ayant_decroche_avant;
								integration_Out_tmp.qualite_relation_enseignants = row1.qualite_relation_enseignants;
								integration_Out_tmp.beneficie_soutien_camarades = row1.beneficie_soutien_camarades;
								integration_Out_tmp.beneficie_soutien_enseignants = row1.beneficie_soutien_enseignants;
								integration_Out_tmp.participation_activites_campus = row1.participation_activites_campus;
								integration_Out = integration_Out_tmp;
// ###############################
							 ...
							 */
// Start of branch "integration_Out"
							if (integration_Out != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									Object exprKeyValue_etudiant_Out__id_etudiant = integration_Out.id_etudiant;
								...
								{ // start of Var scope
									...
									integration_Output = null;

									if (!rejectedInnerJoin_tMap_3) {

// # Output table : 'integration_Output'
										integration_Output_tmp.id_integration = integration_Out.id_integration;
										integration_Output_tmp.id_etudiant = integration_Out.id_etudiant;
										integration_Output_tmp.qualite_relation_camarades = (integration_Out.qualite_relation_camarades == null)
												? "Neutre"
												: integration_Out.qualite_relation_camarades;
										integration_Output_tmp.niveau_integration_sociale = (integration_Out.niveau_integration_sociale == null)
												? "Moyen"
												: integration_Out.niveau_integration_sociale;
										integration_Output_tmp.isolement_social = (integration_Out.isolement_social == null)
												? 0
												: (integration_Out.isolement_social > 0 ? 1 : 0);
										integration_Output_tmp.victime_harcelement = (integration_Out.victime_harcelement == null)
												? 0
												: (integration_Out.victime_harcelement > 0 ? 1 : 0);
										integration_Output_tmp.type_harcelement = (integration_Out.victime_harcelement == 0)
												? "Aucun"
												: (integration_Out.type_harcelement == null ? "Verbal"
														: integration_Out.type_harcelement);
										integration_Output_tmp.pair_ayant_decroche_avant = (integration_Out.pair_ayant_decroche_avant == null)
												? 0
												: (integration_Out.pair_ayant_decroche_avant > 0 ? 1 : 0);
										integration_Output_tmp.qualite_relation_enseignants = (integration_Out.qualite_relation_enseignants == null)
												? "Neutre"
												: integration_Out.qualite_relation_enseignants;
										integration_Output_tmp.beneficie_soutien_camarades = (integration_Out.beneficie_soutien_camarades == null)
												? 0
												: (integration_Out.beneficie_soutien_camarades > 0 ? 1 : 0);
										integration_Output_tmp.beneficie_soutien_enseignants = (integration_Out.beneficie_soutien_enseignants == null)
												? 0
												: (integration_Out.beneficie_soutien_enseignants > 0 ? 1 : 0);
										integration_Output_tmp.participation_activites_campus = (integration_Out.participation_activites_campus == null)
												? "Rarement"
												: integration_Out.participation_activites_campus;
										integration_Output = integration_Output_tmp;
...
// ###############################
								 ...
								 */
// Start of branch "integration_Output"
								if (integration_Output != null) {
									...
									pstmt_tDBOutput_1.setInt(1, integration_Output.id_integration);

									if (integration_Output.id_etudiant == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(2, integration_Output.id_etudiant);
									}

									if (integration_Output.qualite_relation_camarades == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, integration_Output.qualite_relation_camarades);
									}

									if (integration_Output.niveau_integration_sociale == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, integration_Output.niveau_integration_sociale);
									}

									if (integration_Output.isolement_social == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(5, integration_Output.isolement_social);
									}

									if (integration_Output.victime_harcelement == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(6, integration_Output.victime_harcelement);
									}

									if (integration_Output.type_harcelement == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(7, integration_Output.type_harcelement);
									}

									if (integration_Output.pair_ayant_decroche_avant == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(8, integration_Output.pair_ayant_decroche_avant);
									}

									if (integration_Output.qualite_relation_enseignants == null) {
										pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(9, integration_Output.qualite_relation_enseignants);
									}

									if (integration_Output.beneficie_soutien_camarades == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(10, integration_Output.beneficie_soutien_camarades);
									}

									if (integration_Output.beneficie_soutien_enseignants == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(11, integration_Output.beneficie_soutien_enseignants);
									}

									if (integration_Output.participation_activites_campus == null) {
										pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(12,
												integration_Output.participation_activites_campus);
									}
								...
								} // End of branch "integration_Output"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "integration_Out");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "integration_Output");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(integration_Out,etudiant_Out)
...
// ###############################      
	...
	public static void main(String[] args) {
		final Job_06_Integration Job_06_IntegrationClass = new Job_06_Integration();

		int exitCode = Job_06_IntegrationClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_06_Integration.class.getClassLoader()
					.getResourceAsStream("projet_bi/job_06_integration_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_06_Integration.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_06_Integration");
		}
...
/************************************************************************************************
 * 177612 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2026 à 23:13:42 WAT
 ************************************************************************************************/