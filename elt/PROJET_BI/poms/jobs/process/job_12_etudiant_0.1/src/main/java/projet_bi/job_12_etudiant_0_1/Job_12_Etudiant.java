...
package projet_bi.job_12_etudiant_0_1;
...
/**
 * Job: Job_12_Etudiant Purpose: Job_12_Etudiant<br>
 * Description: Job_12_Etudiant <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class Job_12_Etudiant implements TalendJob {
	...
	private final String jobName = "Job_12_Etudiant";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Job_12_Etudiant.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Job_12_Etudiant.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class etudiant_OutputStruct implements routines.system.IPersistableRow<etudiant_OutputStruct> {
		final static byte[] commonByteArrayLock_PROJET_BI_Job_12_Etudiant = new byte[0];
		static byte[] commonByteArray_PROJET_BI_Job_12_Etudiant = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final etudiant_OutputStruct other = (etudiant_OutputStruct) obj;
		...
		public void copyDataTo(etudiant_OutputStruct other) {
		...
		public void copyKeysDataTo(etudiant_OutputStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_BI_Job_12_Etudiant.length) {
					if (length < 1024 && commonByteArray_PROJET_BI_Job_12_Etudiant.length == 0) {
						commonByteArray_PROJET_BI_Job_12_Etudiant = new byte[1024];
					} else {
						commonByteArray_PROJET_BI_Job_12_Etudiant = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_BI_Job_12_Etudiant, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_12_Etudiant, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJET_BI_Job_12_Etudiant, 0, length);
				strReturn = new String(commonByteArray_PROJET_BI_Job_12_Etudiant, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_BI_Job_12_Etudiant) {
		 ...
		 * Compare keys
		 */
		public int compareTo(etudiant_OutputStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				etudiant_OutputStruct etudiant_Output = new etudiant_OutputStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "etudiant_Output");
				}
				...
				String tableName_tDBOutput_1 = "dim_etudiant";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:MKxhe3/ngIVSBphVZd02p5cSk1RO1TwTSUaR+Q==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("dim_etudiant")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_etudiant` INT(2)   not null ,`matricule` VARCHAR(7)  ,`adresse_email` VARCHAR(30)  ,`email_etudiant` VARCHAR(30)  ,`telephone` VARCHAR(16)  ,`nom` VARCHAR(9)  ,`prenom` VARCHAR(10)  ,`genre` VARCHAR(1)  ,`date_naissance` DATETIME ,`niveau_socio_economique` VARCHAR(7)  ,`id_filiere` INT(2)  ,`annee_entree` INT(4)  ,`ville_origine` VARCHAR(12)  ,`situation_matrimoniale` VARCHAR(12)  ,`nb_enfants_a_charge` INT(1)  ,`estime_de_soi` VARCHAR(8)  ,`trait_personnalite` VARCHAR(13)  ,`mention_baccalaureat` VARCHAR(10)  ,`serie_terminale` VARCHAR(23)  ,`decrochage_anterieur` INT(1)  ,`frequence_etude_lecons` VARCHAR(15)  ,`interet_lecture_ecriture` VARCHAR(7)  ,primary key(`id_etudiant`))");
					}
				}
				String replace_tDBOutput_1 = "REPLACE INTO `" + "dim_etudiant"
						+ "` (`id_etudiant`,`matricule`,`adresse_email`,`email_etudiant`,`telephone`,`nom`,`prenom`,`genre`,`date_naissance`,`niveau_socio_economique`,`id_filiere`,`annee_entree`,`ville_origine`,`situation_matrimoniale`,`nb_enfants_a_charge`,`estime_de_soi`,`trait_personnalite`,`mention_baccalaureat`,`serie_terminale`,`decrochage_anterieur`,`frequence_etude_lecons`,`interet_lecture_ecriture`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				etudiant_OutputStruct etudiant_Output_tmp = new etudiant_OutputStruct();
// ###############################
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/home/claude/education_bi_v2/dim_etudiant.csv";
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.id_etudiant = ParserUtils.parseTo_int(temp);
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'id_etudiant' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));

							}

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.matricule = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row1.email_etudiant = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.niveau_socio_economique = fid_tFileInputDelimited_1
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.annee_entree = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"annee_entree", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.annee_entree = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.ville_origine = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							row1.situation_matrimoniale = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.nb_enfants_a_charge = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"nb_enfants_a_charge", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.nb_enfants_a_charge = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 13;

							row1.estime_de_soi = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 14;

							row1.trait_personnalite = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 15;

							row1.mention_baccalaureat = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							row1.serie_terminale = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.decrochage_anterieur = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"decrochage_anterieur", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.decrochage_anterieur = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 18;

							row1.frequence_etude_lecons = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 19;

							row1.interet_lecture_ecriture = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 20;

							row1.adresse_email = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'etudiant_Out'
								etudiant_Out_tmp.id_etudiant = row1.id_etudiant;
								etudiant_Out_tmp.matricule = row1.matricule;
								etudiant_Out_tmp.adresse_email = row1.adresse_email;
								etudiant_Out_tmp.email_etudiant = row1.email_etudiant;
								etudiant_Out_tmp.telephone = row1.telephone;
								etudiant_Out_tmp.genre = row1.genre;
								etudiant_Out_tmp.nom = row1.nom;
								etudiant_Out_tmp.prenom = row1.prenom;
								etudiant_Out_tmp.date_naissance = row1.date_naissance;
								etudiant_Out_tmp.niveau_socio_economique = row1.niveau_socio_economique;
								etudiant_Out_tmp.id_filiere = row1.id_filiere;
								etudiant_Out_tmp.annee_entree = row1.annee_entree;
								etudiant_Out_tmp.ville_origine = row1.ville_origine;
								etudiant_Out_tmp.situation_matrimoniale = row1.situation_matrimoniale;
								etudiant_Out_tmp.nb_enfants_a_charge = row1.nb_enfants_a_charge;
								etudiant_Out_tmp.estime_de_soi = row1.estime_de_soi;
								etudiant_Out_tmp.trait_personnalite = row1.trait_personnalite;
								etudiant_Out_tmp.mention_baccalaureat = row1.mention_baccalaureat;
								etudiant_Out_tmp.serie_terminale = row1.serie_terminale;
								etudiant_Out_tmp.decrochage_anterieur = row1.decrochage_anterieur;
								etudiant_Out_tmp.frequence_etude_lecons = row1.frequence_etude_lecons;
								etudiant_Out_tmp.interet_lecture_ecriture = row1.interet_lecture_ecriture;
...
// Start of branch "etudiant_Out"
							if (etudiant_Out != null) {
								...
								if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
									...
									Object exprKeyValue_filiere_Out__id_filiere = etudiant_Out.id_filiere;
								...
								{ // start of Var scope
									...
									etudiant_Output = null;

									if (!rejectedInnerJoin_tMap_3) {

// # Output table : 'etudiant_Output'
										etudiant_Output_tmp.id_etudiant = etudiant_Out.id_etudiant;
										etudiant_Output_tmp.matricule = etudiant_Out.matricule.trim().toUpperCase();
										etudiant_Output_tmp.adresse_email = etudiant_Out.adresse_email + "_"
												+ etudiant_Out.id_etudiant;
										etudiant_Output_tmp.email_etudiant = (etudiant_Out.email_etudiant == null)
												? null
												: etudiant_Out.email_etudiant.trim().toLowerCase();
										etudiant_Output_tmp.telephone = etudiant_Out.telephone;
										etudiant_Output_tmp.nom = etudiant_Out.nom.trim();
										etudiant_Output_tmp.prenom = etudiant_Out.prenom.trim();
										etudiant_Output_tmp.genre = ("M".equals(etudiant_Out.genre)
												|| "F".equals(etudiant_Out.genre)) ? etudiant_Out.genre : "M";
										etudiant_Output_tmp.date_naissance = etudiant_Out.date_naissance;
										etudiant_Output_tmp.niveau_socio_economique = (etudiant_Out.niveau_socio_economique == null)
												? "Moyen"
												: etudiant_Out.niveau_socio_economique;
										etudiant_Output_tmp.id_filiere = etudiant_Out.id_filiere;
										etudiant_Output_tmp.annee_entree = (etudiant_Out.annee_entree < 2000) ? 2020
												: etudiant_Out.annee_entree;
										etudiant_Output_tmp.ville_origine = (etudiant_Out.ville_origine == null)
												? "Non renseignée"
												: etudiant_Out.ville_origine.trim();
										etudiant_Output_tmp.situation_matrimoniale = (etudiant_Out.situation_matrimoniale == null)
												? "Célibataire"
												: etudiant_Out.situation_matrimoniale;
										etudiant_Output_tmp.nb_enfants_a_charge = (etudiant_Out.nb_enfants_a_charge == null
												|| etudiant_Out.nb_enfants_a_charge < 0) ? 0
														: etudiant_Out.nb_enfants_a_charge;
										etudiant_Output_tmp.estime_de_soi = (etudiant_Out.estime_de_soi == null)
												? "Moyenne"
												: etudiant_Out.estime_de_soi;
										etudiant_Output_tmp.trait_personnalite = (etudiant_Out.trait_personnalite == null)
												? "Ambiverti"
												: etudiant_Out.trait_personnalite;
										etudiant_Output_tmp.mention_baccalaureat = (etudiant_Out.mention_baccalaureat == null)
												? "Passable"
												: etudiant_Out.mention_baccalaureat;
										etudiant_Output_tmp.serie_terminale = (etudiant_Out.serie_terminale == null)
												? "D (Maths-SVT)"
												: etudiant_Out.serie_terminale;
										etudiant_Output_tmp.decrochage_anterieur = (etudiant_Out.decrochage_anterieur == null)
												? 0
												: (etudiant_Out.decrochage_anterieur > 0 ? 1 : 0);
										etudiant_Output_tmp.frequence_etude_lecons = (etudiant_Out.frequence_etude_lecons == null)
												? "Parfois"
												: etudiant_Out.frequence_etude_lecons;
										etudiant_Output_tmp.interet_lecture_ecriture = (etudiant_Out.interet_lecture_ecriture == null)
												? "Moyen"
												: etudiant_Out.interet_lecture_ecriture;
										etudiant_Output = etudiant_Output_tmp;
...
// ###############################
								 ...
								 */
// Start of branch "etudiant_Output"
								if (etudiant_Output != null) {
									...
									pstmt_tDBOutput_1.setInt(1, etudiant_Output.id_etudiant);

									if (etudiant_Output.matricule == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, etudiant_Output.matricule);
									}

									if (etudiant_Output.adresse_email == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, etudiant_Output.adresse_email);
									}

									if (etudiant_Output.email_etudiant == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, etudiant_Output.email_etudiant);
									}

									if (etudiant_Output.telephone == null) {
										pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(5, etudiant_Output.telephone);
									}

									if (etudiant_Output.nom == null) {
										pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(6, etudiant_Output.nom);
									}

									if (etudiant_Output.prenom == null) {
										pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(7, etudiant_Output.prenom);
									}

									if (etudiant_Output.genre == null) {
										pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(8, etudiant_Output.genre);
									}

									if (etudiant_Output.date_naissance != null) {
										date_tDBOutput_1 = etudiant_Output.date_naissance.getTime();
									...
									if (etudiant_Output.niveau_socio_economique == null) {
										pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(10, etudiant_Output.niveau_socio_economique);
									}

									if (etudiant_Output.id_filiere == null) {
										pstmt_tDBOutput_1.setNull(11, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(11, etudiant_Output.id_filiere);
									}

									if (etudiant_Output.annee_entree == null) {
										pstmt_tDBOutput_1.setNull(12, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(12, etudiant_Output.annee_entree);
									}

									if (etudiant_Output.ville_origine == null) {
										pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(13, etudiant_Output.ville_origine);
									}

									if (etudiant_Output.situation_matrimoniale == null) {
										pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(14, etudiant_Output.situation_matrimoniale);
									}

									if (etudiant_Output.nb_enfants_a_charge == null) {
										pstmt_tDBOutput_1.setNull(15, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(15, etudiant_Output.nb_enfants_a_charge);
									}

									if (etudiant_Output.estime_de_soi == null) {
										pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(16, etudiant_Output.estime_de_soi);
									}

									if (etudiant_Output.trait_personnalite == null) {
										pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(17, etudiant_Output.trait_personnalite);
									}

									if (etudiant_Output.mention_baccalaureat == null) {
										pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(18, etudiant_Output.mention_baccalaureat);
									}

									if (etudiant_Output.serie_terminale == null) {
										pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(19, etudiant_Output.serie_terminale);
									}

									if (etudiant_Output.decrochage_anterieur == null) {
										pstmt_tDBOutput_1.setNull(20, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(20, etudiant_Output.decrochage_anterieur);
									}

									if (etudiant_Output.frequence_etude_lecons == null) {
										pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(21, etudiant_Output.frequence_etude_lecons);
									}

									if (etudiant_Output.interet_lecture_ecriture == null) {
										pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(22, etudiant_Output.interet_lecture_ecriture);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "etudiant_Output");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_3 - inputs:(etudiant_Out,filiere_Out)
				// outputs:(etudiant_Output)
...
// ###############################      
	...
	public static void main(String[] args) {
		final Job_12_Etudiant Job_12_EtudiantClass = new Job_12_Etudiant();

		int exitCode = Job_12_EtudiantClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job_12_Etudiant.class.getClassLoader()
					.getResourceAsStream("projet_bi/job_12_etudiant_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Job_12_Etudiant.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Job_12_Etudiant");
		}
...
/************************************************************************************************
 * 173001 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2026 à 23:31:15 WAT
 ************************************************************************************************/